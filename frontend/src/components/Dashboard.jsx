...
export default function Dashboard({ 
  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: 1280, margin: '0 auto', padding: '24px 20px 80px 20px' }}>
      {/* Header Panel */}
      <div className="glass-panel glass-panel-glow dashboard-header" style={{ padding: '24px 30px', marginBottom: 24, display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 20 }}>
        <div>
      ...
      <div className="glass-panel sync-control-panel" style={{ padding: '16px 24px', marginBottom: 24, display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 16 }}>
      ...
      <div className="toolbar-container" style={{ display: 'flex', flexWrap: 'wrap', gap: 16, marginBottom: 20 }}>
        {/* Search */}
        ...
        <div className="filter-button-group" style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <button 
